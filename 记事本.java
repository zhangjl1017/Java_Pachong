...
public class HelloWord extends JFrame implements ActionListener,DocumentListener
{    //菜单
	...
	//“帮助”的菜单项
	JMenuItem helpMenu_HelpTopics,helpMenu_AboutHelloWord;
	//“文本”编辑区域
	JTextArea editArea;
	//状态栏标签
	JLabel statusLabel;
	...
	{	
		...
		helpMenu_AboutHelloWord = new JMenuItem("关于记事本(A)"); 
		helpMenu_AboutHelloWord.addActionListener(this);
		...
		helpMenu.add(helpMenu_AboutHelloWord);
	...
	{	final JDialog fontDialog=new JDialog(this,"字体设置",false);
		...
		final JLabel sample=new JLabel("张选仲的记事本-ZXZ's HelloWord");
	...
	{	//新建
		...
		//关于
		else if(e.getSource()==helpMenu_AboutHelloWord)
		{	editArea.requestFocus();
	...
	{	HelloWord HelloWord=new HelloWord();
		HelloWord.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);//使用 System exit 方法退出应用程序
	}//main函数结束
}
